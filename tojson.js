...
async function convertSheetToJson() {
  const doc = await getAuth("1qCwrCW8v6hDHPWuvwGsZrUgDrV41or7AQWsgWADCyoo");
  const sheet = doc.sheetsByTitle["FE_ScreenFields"]; // assuming the data is in the first sheet
